...
const AdminForgotPass = () => {
  ...
  const handleSendOtp = async () => {
    try {
      const res = await fetch("http://localhost:5000/api/admin/forgot-password/send-otp", {
        method: "POST",
    ...
    try {
      const res = await fetch("http://localhost:5000/api/admin/forgot-password/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
