...
import ProfileImage from "../../assets/engback.jpg"; // Replace with actual path
...
const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const [formData, setFormData] = useState({
    ...
    mobilep: "0740563227",
    mobileb: "0785509917",
    designation: "Associate Cyber Security Engineer",
  });
