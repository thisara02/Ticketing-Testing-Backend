          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col">
              ...
              <div className="mt-6">
                ...
                ></textarea>
                <button
                  className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-400 transition mb-4"
                  onClick={() => {
                    if (commentText.trim()) {
