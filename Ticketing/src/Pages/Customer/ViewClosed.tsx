...
const ViewClosed = () => {
  ...
  useEffect(() => {
    const fetchTicketDetails = async () => {
      ...
      try {
        ...
        const response = await fetch(`http://localhost:5000/api/customers/closetickets/${ticketId}`, {
          headers: {
  ...
  //     const response = await fetch(`http://localhost:5000/api/customers/ontickets/${ticketId}/comments`, {
  //       method: "POST",
  //       headers: {
