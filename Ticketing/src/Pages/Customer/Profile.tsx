...
useEffect(() => {
  ...
  try {
    ...
    formPayload.append("mobilep", formData.mobile); 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <input
                  ...
                  readOnly
                  className="mt-1 w-full border border-gray-300 rounded px-3 py-2 bg-gray-100 cursor-not-allowed text-black font-jura"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 font-jura">
