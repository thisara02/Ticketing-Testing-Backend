...
const AMResetPass = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("http://localhost:5000/api/accountmanager/reset-password", {
        method: "POST",
  ...
  return (
    <div className="relative min-h-screen w-screen flex items-center justify-center font-jura">
      ...
      <div className="relative z-10 bg-white shadow-xl rounded-xl p-12 w-3/5 max-w-md">
        <button
          onClick={() => navigate("/eng-login")}
